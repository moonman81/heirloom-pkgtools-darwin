...
- **C sources**: check.c, delmap.c, main.c, predepend.c, quit.c, special.c, wsreg_pkgrm.c, wsreg_pkgrm_test.c
- **Headers**: heirloom_flags.h, wsreg_pkgrm.h
