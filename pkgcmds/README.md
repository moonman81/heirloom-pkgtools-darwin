...
user-facing pkg commands (pkgadd/pkgrm/pkgchk/etc.).
...
- **Build**: makefile
- **Subdirs**: installf, pkgadd, pkgadm, pkgchk, pkgcond, pkginfo, pkginstall, pkgmk, pkgname, pkgparam, pkgproto, pkgremove, pkgrm, pkgscripts, pkgtrans
