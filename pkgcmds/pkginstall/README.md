...
- **C sources**: backup.c, check.c, cppath.c, dockspace.c, getinst.c, instvol.c, main.c, merginfo.c, pkgenv.c, pkgvolume.c, predepend.c, quit.c (+3 more)
- **Headers**: heirloom_flags.h, msgdefs.h, pkginstall.h
