...
`pkgadm` — see the repo root docs for context.
...
- **C sources**: addcert.c, certs.c, listcert.c, lock.c, main.c, pkgadm_contents.c, pkgadm_db.c, pkgadm_special.c, removecert.c
- **Headers**: heirloom_flags.h, pkgadm.h, pkgadm_msgs.h
- **Build**: Makefile.mk
